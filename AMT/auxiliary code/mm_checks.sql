...
-- each concept has 'Ingredient' concept_class_id check
SELECT *
FROM ingredient_mm
...
-- each concept has 'Brand Name' concept_class_id check
SELECT *
FROM brand_name_mm
...
-- each concept has 'Supplier' concept_class_id check
SELECT *
FROM supplier_mm
...
-- each concept has 'Dose Form' concept_class_id check
SELECT *
FROM dose_form_mm
...
-- each concept has 'Unit' concept_class_id check
SELECT *
FROM unit_mm
