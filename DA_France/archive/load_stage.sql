...
WHERE coalesce(a.strg_meas,'NULL') NOT IN (
		'CH',
		'NULL'
		);
...
WHERE volume is not NULL
	AND coalesce(strg_meas,'NULL') NOT IN (
		'%',
		'NULL'
		)
...
--volume is  NULL AND strg_unit !='NULL' AND MOLECULE NOT LIKE '%+%' AND strg_meas = '%'
INSERT INTO ds_stage (
	drug_concept_code,
	ingredient_concept_code,
	numerator_value,
