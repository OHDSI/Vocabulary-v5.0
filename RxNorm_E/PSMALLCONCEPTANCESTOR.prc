...
BEGIN
   ...
   EXECUTE IMMEDIATE
	...
	join concept c1 on c1.concept_id=r.concept_id_1 and c1.invalid_reason is null and c1.vocabulary_id in (''RxNorm'',''RxNorm Extension'',''ATC'',''NFC'',''EphMRA ATC'',''CVX'')
	join concept c2 on c2.concept_id=r.concept_id_2 and c2.invalid_reason is null and c2.vocabulary_id in (''RxNorm'',''RxNorm Extension'',''ATC'',''NFC'',''EphMRA ATC'',''CVX'')
