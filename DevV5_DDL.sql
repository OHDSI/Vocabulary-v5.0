...
ALTER TABLE concept ADD CONSTRAINT xpk_concept PRIMARY KEY (concept_id) ENABLE NOVALIDATE;
ALTER TABLE vocabulary ADD CONSTRAINT xpk_vocabulary PRIMARY KEY (vocabulary_id) ENABLE NOVALIDATE;
ALTER TABLE domain ADD CONSTRAINT xpk_domain PRIMARY KEY (domain_id) ENABLE NOVALIDATE;
ALTER TABLE concept_class ADD CONSTRAINT xpk_concept_class PRIMARY KEY (concept_class_id) ENABLE NOVALIDATE;
ALTER TABLE concept_relationship ADD CONSTRAINT xpk_concept_relationship PRIMARY KEY (concept_id_1,concept_id_2,relationship_id) ENABLE NOVALIDATE;
ALTER TABLE relationship ADD CONSTRAINT xpk_relationship PRIMARY KEY (relationship_id) ENABLE NOVALIDATE;
ALTER TABLE concept_ancestor ADD CONSTRAINT xpk_concept_ancestor PRIMARY KEY (ancestor_concept_id,descendant_concept_id) ENABLE NOVALIDATE;
ALTER TABLE source_to_concept_map ADD CONSTRAINT xpk_source_to_concept_map PRIMARY KEY (source_vocabulary_id,target_concept_id,source_code,valid_end_date) ENABLE NOVALIDATE;
ALTER TABLE drug_strength ADD CONSTRAINT xpk_drug_strength PRIMARY KEY (drug_concept_id, ingredient_concept_id) ENABLE NOVALIDATE;
