--new relationship 'Has PPI parent code'
DO $$
DECLARE
    z    int;
    ex   int;
    pRelationship_name constant varchar(100):='Has PPI parent code';
    pRelationship_id constant varchar(100):='Has PPI parent code' ;
    pIs_hierarchical constant int:=0;
    pDefines_ancestry constant int:=0;
    pReverse_relationship_id constant varchar(100):='PPI parent code of';

    pRelationship_name_rev constant varchar(100):='PPI parent code of';
