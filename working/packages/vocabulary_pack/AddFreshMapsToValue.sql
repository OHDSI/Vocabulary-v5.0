...
BEGIN
	...
	WHERE r.invalid_reason IS NULL
		...
		AND crs.concept_code_1 IS NULL --we need only fresh 'Maps to/value' which contains in stage-tables (per each concept_code_1), but if we doesn't have them - take from base tables
