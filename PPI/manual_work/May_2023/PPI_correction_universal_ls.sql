...
SET valid_end_date = '2023-05-05', invalid_reason='D'
...
DO $LATESTUPDATE$
DECLARE
	pVocabs CONSTANT VARCHAR[]:=ARRAY['PPI']; --ARRAY['NDC','SPL']
	pSchemaName CONSTANT TEXT:='dev_ppi';
...
SELECT * FROM Dev_ppi.concept
         WHERE concept_id=40192497;

SELECT * FROM Dev_ppi.concept_relationship
         WHERE concept_id_1=40192497;