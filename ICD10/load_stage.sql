...
--6 Delete duplicate mappings (one concept has multiply target concepts)
...
--13 Add "subsumes" relationship between concepts where the concept_code is like of another
...
--14 update domain_id for ICD10 from SNOMED
...
--15. Simplify the list by removing Observations
...
--16. update each domain_id with the domains field from ICD10_domain.
