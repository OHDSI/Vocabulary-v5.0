...
;
UPDATE tomap_bn 
set invalid_indicator = 'D'
where concept_name ~ ' Mono|Sandoz|Mylan| Teva|EG|Pharma Nord| Thea|Toularynx|Accord Healthcare| Serb| Kabi| Krka|Braun|Hospira| AB|Accord|Scheffler|Ferring|UCB|Apotex|Sterop|Aguettant| Leo|Amdipharm|Continu|Medac|Yamanouchi| Kela|Pharmaceuticals|Belpharma|Lilly|Farmaceutica|Richter|Ratiopharm|Minims|Unimedic|Besins|Conforma|Eurogenerics|Stragen|Pfizer|Celgene|Eumedica|COMOD| Pura|Baxalta';
...
--update /cmІ to have proper denominator
with square_denom as
	(
		...
		where denominator_unit = 'cmІ' and inbasq = 1 and dim is not null
	),
calc as
	(
		select distinct
