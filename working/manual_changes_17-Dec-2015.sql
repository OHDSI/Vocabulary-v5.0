...
UPDATE concept SET domain_id = 'Type Concept' WHERE domain_id LIKE '%Type'; 
ALTER TABLE concept ENABLE CONSTRAINT FPK_CONCEPT_DOMAIN;

-- Deprecate concepts
update concept set
 valid_end_date='15-Oct-2015',
 invalid_reason='U'
where concept_id in (select domain_concept_id from domain where domain_id like '%Type');

-- Create upgrade relationships to new "Concept Type" domain
insert into concept_relationship
select domain_concept_id, 58, 'Concept replaced by', '16-Oct-2015', '31-Dec-2099', null 
from domain where domain_id like '%Type';

insert into concept_relationship
select 58, domain_concept_id, 'Concept replaces', '16-Oct-2015', '31-Dec-2099', null 
from domain where domain_id like '%Type';

-- remove domains
delete from domain where domain_id like '%Type';

-- Rename Genseqno to GCN_SEQNO
update concept set concept_name = 'Clinical Formulation ID (FDB)' where concept_id=44819141;
insert into vocabulary (vocabulary_id, vocabulary_name, vocabulary_reference, vocabulary_version, vocabulary_concept_id)
values ('GCN_SEQNO', 'Clinical Formulation ID (FDB)', 'FDB US distribution package', '20151119', 44819141);
update concept set vocabulary_id = 'GCN_SEQNO' where vocabulary_id = 'Genseqno';
update vocabulary_conversion set vocabulary_id_v5 = 'GCN_SEQNO' where vocabulary_id_V5 = 'Genseqno';
delete from vocabulary where vocabulary_id = 'Genseqno';
update concept set concept_name = 'GCN_SEQNO' where concept_id=44819254;
insert into concept_class (concept_class_id, concept_class_name, concept_class_concept_id)
values ('GCN_SEQNO', 'GCN_SEQNO', 44819254);
update concept set concept_class_id = 'GCN_SEQNO' where concept_class_id = 'Genseqno';
delete from concept_class where concept_class_id = 'Genseqno';

-- Make GCN_SEQNO 6 digits long
update concept set concept_code = to_char(concept_code, '000000') where vocabulary_id = 'GCN_SEQNO';
update concept set concept_code = substr(concept_code, 2, 6) where vocabulary_id = 'GCN_SEQNO';

-- Make ETC 8 digits long
update concept set concept_code = to_char(concept_code, '00000000') where vocabulary_id = 'ETC';
update concept set concept_code = substr(concept_code, 2, 8) where vocabulary_id = 'ETC';

-- Remove duplicate GCN_SEQNO, first synonyms, then concepts
delete from concept_synonym where concept_id = 45710886;
delete from concept_synonym where concept_id = 45719085;
delete from concept_synonym where concept_id = 45710887;
delete from concept_synonym where concept_id = 45724606;
delete from concept_synonym where concept_id = 45727451;
delete from concept_synonym where concept_id = 45713650;
delete from concept_synonym where concept_id = 45713652;
delete from concept_synonym where concept_id = 45730185;
delete from concept_synonym where concept_id = 45727494;
delete from concept_synonym where concept_id = 45724664;
delete from concept_synonym where concept_id = 45721901;
delete from concept_synonym where concept_id = 45716380;
delete from concept_synonym where concept_id = 45724686;
delete from concept_synonym where concept_id = 45719191;
delete from concept_synonym where concept_id = 45724688;
delete from concept_synonym where concept_id = 45711130;
delete from concept_synonym where concept_id = 45727373;
delete from concept_synonym where concept_id = 45727378;
delete from concept_synonym where concept_id = 45713632;

delete from concept where concept_id = 45710886;
delete from concept where concept_id = 45719085;
delete from concept where concept_id = 45710887;
delete from concept where concept_id = 45724606;
delete from concept where concept_id = 45727451;
delete from concept where concept_id = 45713650;
delete from concept where concept_id = 45713652;
delete from concept where concept_id = 45730185;
delete from concept where concept_id = 45727494;
delete from concept where concept_id = 45724664;
delete from concept where concept_id = 45721901;
delete from concept where concept_id = 45716380;
delete from concept where concept_id = 45724686;
delete from concept where concept_id = 45719191;
delete from concept where concept_id = 45724688;
delete from concept where concept_id = 45711130;
delete from concept where concept_id = 45727373;
delete from concept where concept_id = 45727378;
delete from concept where concept_id = 45713632;

delete from concept_synonym where concept_id = 45719054;
delete from concept_synonym where concept_id = 45719055;
delete from concept_synonym where concept_id = 45710850;

delete from concept where concept_id = 45719054;
delete from concept where concept_id = 45719055;
delete from concept where concept_id = 45710850;

delete from concept_synonym s 
where exists (
  select 1 from (
    select concept_code from concept where vocabulary_id='GCN_SEQNO' 
    group by concept_code having count(8)>1
  ) d 
  join concept c on c.concept_code=d.concept_code and c.vocabulary_id='GCN_SEQNO' and not regexp_like(c.concept_name, '[a-z%]')
  where s.concept_id=c.concept_id 
)
;

delete from concept c where exists (
  select 1 from (
    select concept_code from concept where vocabulary_id='GCN_SEQNO' 
    group by concept_code having count(8)>1
  ) d 
  where c.concept_code=d.concept_code and c.vocabulary_id='GCN_SEQNO'
  and not regexp_like(c.concept_name, '[a-z%]')
)
;

-- Make Indications 8 digits long
update concept set concept_code = substr(to_char(concept_code, '00000000'), 2, 8) where vocabulary_id = 'Indication';
