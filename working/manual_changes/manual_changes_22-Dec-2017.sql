DECLARE
    z    number;
    ex   number;
    pVocabulary_id constant varchar2(100):='BCFI';
    pVocabulary_name constant varchar2(100):= 'BCFI';
    ...
    pVocabulary_version constant varchar2(100):='BCFI update oktober 2017';
BEGIN
    BEGIN
