...
;
       ...
       CASE WHEN  AND f.main_category NOT IN (148, 1307, 9081, 17518, 18518, 51428, 100078, 100079, 100080, 100081, 100082, 100083, 100084, 100085, 100086, 100087)
            THEN 'S'ELSE

SELECT main_category,
       field_id,
       CASE WHEN f.encoding_id != 0 THEN 'S'
            ELSE NULL
