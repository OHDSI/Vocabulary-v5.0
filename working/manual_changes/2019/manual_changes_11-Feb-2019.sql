--Add new relationship_id for SNOMED
DO $$
DECLARE
    z    int;
    ex   int;
    pRelationship_name constant varchar(100):='Plays role';
    pRelationship_id constant varchar(100):='Plays role';
    pIs_hierarchical constant int:=0;
    pDefines_ancestry constant int:=0;
    pReverse_relationship_id constant varchar(100):='Role played by';
    
    pRelationship_name_rev constant varchar(100):='Role played by';
