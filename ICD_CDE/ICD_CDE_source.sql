...
SELECT DISTINCT source_code, source_code_description, source_vocabulary_id, group_id, source_code_description
    FROM grouped;

INSERT INTO cde_manual_group (source_code, source_code_description, source_vocabulary_id, group_id, group_name)
SELECT DISTINCT source_code_1, source_code_description_1, source_vocabulary_id_1, group_id, source_code_description_1
    FROM grouped
