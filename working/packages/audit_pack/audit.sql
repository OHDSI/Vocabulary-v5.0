...
CREATE TABLE audit.logged_propogated_maps_to (
...
CREATE INDEX idx_logged_propogated_maps_to_1 ON audit.logged_propogated_maps_to USING btree (created);
CREATE INDEX idx_logged_propogated_maps_to_2 ON audit.logged_propogated_maps_to USING btree (vocabulary_id_1, vocabulary_id_2);
CREATE INDEX idx_logged_propogated_maps_to_3 ON audit.logged_propogated_maps_to USING btree (relationship_id);