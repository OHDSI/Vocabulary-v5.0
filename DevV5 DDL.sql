...
ALTER TABLE drug_strength ADD CONSTRAINT fpk_drug_strength_concept_1 FOREIGN KEY (drug_coCREATE INDEX idx_concept_concept_id ON concept (concept_id ASC);
...
CREATE INDEX idx_drug_strength_id_2 ON drug_strength (ingredient_concept_id ASC);ncept_id) REFERENCES concept (concept_id);
