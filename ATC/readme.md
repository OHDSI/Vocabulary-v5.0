...
- Schema DevV5 with copies of concept, concept_relationship and concept_synonym tables from prodV5, fully indexed.
...
END $_$;
```
5. Run checks and collect statistics after generic:
```sql
