...
SELECT c.concept_name,
       ...
       c.invalid_reason,
       c.domain_id,
       CASE WHEN relationship_id = 'Maps to' THEN ''
            WHEN relationship_id = 'Maps to value' THEN 'to value'
            ELSE relationship_id END,
       NULL,
       cc.concept_id,
       cc.concept_code,
       cc.concept_name,
...
ON crm.concept_code_1 = c.concept_code AND c.vocabulary_id = 'SNOMED'
JOIN devv5.concept cc
ON crm.concept_code_2 = cc.concept_code AND crm.vocabulary_id_2 = cc.vocabulary_id

ORDER BY c.concept_code, relationship_id, cc.concept_id
;