...
8.6. If everything is OK, deprecate old mappings for the ICD10CN codes of interest and add fresh mappings to the concept_relationship_manual using crm_changes.sql script
