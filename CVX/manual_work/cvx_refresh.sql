--12.3.1. Create cvx_mapped table and pre-populate it with the resulting manual table of the previous cvx refresh.
...
--12.3.2. Review the previous mappings and manually add new to the cvx_mapped table.
...
--12.3.5. Iteratively repeat steps 3.3-3.5 if found any issues.
