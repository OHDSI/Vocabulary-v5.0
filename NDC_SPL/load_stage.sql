...
update vocabulary set latest_update=to_date('20150326','yyyymmdd'), vocabulary_version='NDC 20150326' where vocabulary_id='NDC'; commit;
update vocabulary set latest_update=to_date('20150326','yyyymmdd'), vocabulary_version='NDC 20150326' where vocabulary_id='SPL'; commit;
