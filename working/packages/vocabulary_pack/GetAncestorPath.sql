CREATE OR REPLACE FUNCTION vocabulary_pack.getancestorpath (
  pancestorid integer,
...
BEGIN
    ...
    concepts as (
        ...
        join devv5.concept c1 on c1.concept_id=r.concept_id_1 and c1.invalid_reason is null
        join devv5.concept c2 on c2.concept_id=r.concept_id_2 and c2.invalid_reason is null
        where r.invalid_reason is null
    )    
    select 
        hc.root_ancestor_concept_id as ancestor_concept_id, hc.descendant_concept_id, hc.hierarchy_path
    from hierarchy_concepts hc
    join devv5.concept c1 on c1.concept_id=hc.root_ancestor_concept_id and c1.standard_concept is not null
    join devv5.concept c2 on c2.concept_id=hc.descendant_concept_id and c2.standard_concept is not null
