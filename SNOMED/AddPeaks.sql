...
-- Outdated
	--2014-Dec-18
	(218496004,		'Сondition',	TO_DATE('20141218', 'YYYYMMDD'),	TO_DATE('20170810', 'YYYYMMDD')), -- Adverse reaction to primarily systemic agents
	...
	(422989001,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Appendix with tumor involvement, with perforation not at tumor
	(384980008,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Atelectasis AND/OR obstructive pneumonitis of entire lung associated with direct extension of malignant neoplasm
	(396895006,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Endocrine pancreas tumor finding
	(422805009,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Erosion of esophageal tumor into bronchus
	(423018005,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Erosion of esophageal tumor into trachea
	(399527001,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Invasive ovarian tumor omental implants present
	(399600009,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Lymphoma finding
	(405928008,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Renal sinus vessel involved by tumor
	(405966006,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Renal tumor finding
	(385356007,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Tumor stage finding
	...
	(386702006,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Victim of abuse
	(95930005,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20160322', 'YYYYMMDD')), -- Victim of neglect
	...
	--2018-Oct-06
	(414916001,		'Сondition',	TO_DATE('20181006', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Obesity
	...
	--2020-Mar-17
	(41769001,		'Сondition',	TO_DATE('20200317', 'YYYYMMDD'),	TO_DATE('20200428', 'YYYYMMDD')), -- Disease suspected
	--2020-Nov-04
	...
	--2021-Oct-27
	(62305002,		'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Disorder of language
	(289161009,		'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Finding of appetite
	(309298003,		'Observation',  TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Drug therapy finding
	(271807003,		'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Eruption
	(402752000,		'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Dermatosis resulting from cytotoxic therapy
	--2022-05-04
	(365726006,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Finding related to ability to process information accurately
	(365737007,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Finding related to ability to process information at normal speed
	(365748000,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Finding related to ability to analyze information
	(59274003,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Intentional drug overdose
	...
	(782964007,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Genetic disease
	(237834000,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Disorder of stature
	(400038003,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Congenital malformation syndrome
	...
	(231466009,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Acute drug intoxication
...
-- Relevant
	...
	(124083000,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Urobilinogenemia
	(71922006,		'Condition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Immune defect
	(413296003,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Depression requiring intervention
	(103020000,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Adrenarche
	(405729008,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hematochezia
	(300391003,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of appearance of stool
	(300393000,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of odor of stool
	(165816005,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- HIV positive
	(106019003,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of elimination pattern
	...
	(448717002,		'Сondition',	TO_DATE('20170810', 'YYYYMMDD'),	TO_DATE('20231013', 'YYYYMMDD')), -- Decline in Edinburgh postnatal depression scale score
	--history:off
	--history:on
	...
	(449413009,		'Сondition',	TO_DATE('20170810', 'YYYYMMDD'),	TO_DATE('20231013', 'YYYYMMDD')), -- Decline in Edinburgh postnatal depression scale score at 8 months
	--history:off
	--history:on
	...
	(441742003,		'Сondition',	TO_DATE('20170810', 'YYYYMMDD'),	TO_DATE('20201104', 'YYYYMMDD')), -- Evaluation finding
	(441742003,		'Measurement',	 TO_DATE('20201104', 'YYYYMMDD'),	TO_DATE('20201210', 'YYYYMMDD')), -- Evaluation finding
	(441742003,		'Сondition',	TO_DATE('20201210', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Evaluation finding
	--history:off
	...
	(118227000,		'Сondition',	TO_DATE('20170810', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Vital signs finding
	(473010000,		'Сondition',	TO_DATE('20171116', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hypersensitivity condition
	...
	(29164008,		'Сondition',	TO_DATE('20201110', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Disturbance in speech
	(288579009,		'Сondition',	TO_DATE('20201110', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Difficulty communicating
	(288576002,		'Сondition',	TO_DATE('20201110', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Unable to communicate
	(229621000,		'Сondition',	TO_DATE('20201110', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Disorder of fluency
	...
	(268935007,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- On examination - peripheral pulses right leg
	(268936008,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- On examination - peripheral pulses left leg
	(164399004,		'Observation',  TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- O/E - skin scar
	(165815009,		'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- HIV negative
	(365956009,		'Observation',  TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of sexual orientation

	(106028002,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Musculoskeletal finding
	--history:on
	(65367001,		'Observation',  TO_DATE('20141218', 'YYYYMMDD'),	TO_DATE('20150119', 'YYYYMMDD')), -- Victim status
	(65367001,		'Сondition',	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20150311', 'YYYYMMDD')), -- Victim status
	...
	--history:off
	(106132005,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Speech finding
	(248982007,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Pregnancy, childbirth and puerperium finding
	(106089007,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Metabolic finding
	(714628002,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Prediabetes
	(419026008,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Effect of exposure to physical force
	(300848003,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Mass of body structure
	(84452004,		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hormone abnormality
	(299691001,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of blood, lymphatics and immune system
	(69328002,		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Distress
	(267038008,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Edema
	...
	(25470001000004105,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Cognitive impairment due to multiple sclerosis
	...
	(131148009,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Bleeding
	...
	(246556002,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Central nervous system finding
	(300862005,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Mass of body region
	(302292003,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of trunk structure
	(298314008, 	 'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding related to coordination / incoordination
	(248402002,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- General finding of soft tissue
	(302293008,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of limb structure
	(298325004,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of movement
	(43029002,		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Abnormal posture
	(118254002,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of head and neck region
	(361055000,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Misuses drugs
	(414252009,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of back
	(106030000,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Muscle finding
	(106129007,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Motor function behavior finding
	(816081007,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Extracellular fluid volume depletion
	(386617003,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Digestive system finding
	(8659000,		'Condition', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Ectopic production of endocrine substance
	(415531008,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Skin AND/OR mucosa finding
	...
	(248457000,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Rigor - symptom
	--history:on
	(48340000,		'Сondition',	TO_DATE('20141218', 'YYYYMMDD'),	TO_DATE('20150119', 'YYYYMMDD')), -- Incontinence
	(48340000,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Incontinence
	--history:off
	(165232002,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Urinary incontinence
	...
	(271787007,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Collapse
	...
	(762434003,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hypocitraturia
	...
	(10917810000001008,		'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Myoglobinuria
	...
	(68600005,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hemoglobinuria
	(59828008,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hemolytic crisis
	(123770000,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Methemalbuminemia
	(89627008,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hyponatremia
	...
	(1162569002,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Postoperative bacteremia
	...
	-- Joint stiffness
	(84445001,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(249912007,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(249917001,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(298241001,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(249915009,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(249914008,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(298232006,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(249913002,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(40144003,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(202510005,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(249918006,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(298231004,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),
	(249916005,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')),

	(300857009,  	'Condition', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Mass of urinary system structure
	(20154006,  		'Condition', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Pneumatouria
	(300474003,  	'Condition', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of urine output
	(76023003,  		'Condition', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Impairment of urinary concentration
	...
	(42341009,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Agnosia
	(27206009,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Agraphia
	(102996009,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Cryesthesia
	(32566006,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Dysmetria
	(39051003,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Kernig's sign
	(70537007,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hegar's sign
	(9686009,  			'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Goodell's sign
	(15311007,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Erichsen's sign
	(441461000,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Destot sign
	(44717005,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Chvostek sign
	(413814005,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Chadwick's sign
	(70651004,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Calkin's sign
	(82345001,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Brudzinski's sign

	(37057007,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Psychophysiologic disorder
	(386661006,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Fever
	(48188009,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Azoospermia
	(162274004,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Visual symptoms
	(106134006,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Perception AND/OR perception disturbance
	(12479006,  		'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Compulsive behavior
	(301366005,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Pain of truncal structure
	(309524007,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Mass pf trunk
	(724386005,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Lesion of genitalia
	(106102002,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Abnormal urinary product
	(21639008,			'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hypervolemia
	(312087002,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Disorder following clinical procedure
	(14760008,			'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Constipation
	(62315008,			'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Diarrhea
	(250411006,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Bone marrow finding
	(76612001,			'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hypercoagulability state
	...
	(366092004, 		'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Eye measurements - finding
	(366158000, 		'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Vascular measurements - finding
	(106200001, 		'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hematopoietic system finding
	...
	(45089002,			'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Normal vision
	(301979008,			'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of color vision
	(246638009,			'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Interference with vision
	...
	(225580001,		  	'Observation',  TO_DATE('20230927', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of stoma device
	...
	(36456004,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Mental state finding
	(118242002,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding by palpation
	(118244001,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding by percussion
	(247700009,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Normal perception
	(102500002,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Good neonatal condition at birth
	(297976006,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of temperature of skin
	-- history: on
	(106146005,			'Сondition', 	TO_DATE('20150119', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Reflex finding
	(106146005,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Reflex finding
	-- history: off
	(299956006,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Normal sensation
	(609625009,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of pelvic region of trunk
	(5277004,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Urinary casts
	(300361008,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Vomit contains blood
	(719602003,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Radiologic finding of tumor invasion penetrating colonic serosa
	(102866000,			'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Abnormal urine
	(5271000124101, 	'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Normal cranial nerves
	(77386006,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Pregnancy
	(366256008,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of bowel action
	(398018000,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Inadequate anesthetic assessment
	(365636006,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of blood group
	(167911000,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Bone marrow examination abnormal
	(366219004,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Tendency to bleed - finding
	(1156330008,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Normal respiratory system
	(106098005,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Urinary system finding
	(365619003,  		'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Finding of red blood cell morphology

	--history:on
	(710954001,			'Measurement',	 TO_DATE('20200317', 'YYYYMMDD'),	TO_DATE('20220504', 'YYYYMMDD')), -- Bacteria present
	(710954001,			'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20230914', 'YYYYMMDD')), -- Bacteria present
	...
	(284530008,			'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Communication, speech and language finding
	--history:off
	--Context-dependent
	(395098000,			'Сondition',	TO_DATE('20200518', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Disorder confirmed
	...
	--history:off
	(28926001,			'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Eruption due to drug
	(402752000,			'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Dermatosis resulting from cytotoxic therapy
	(407674008,			'Сondition',	TO_DATE('20220504', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Aspirin-induced asthma
	(10628711000119101,	'Сondition',	TO_DATE('20171116', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Allergic contact dermatitis caused by plant (this is only one child of 419199007 Allergy to substance that has exact condition mentioned
	(424909003,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Toxic retinopathy
	(312963001,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Methanol retinopathy
	(82545002,			'Condition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Blood transfusion reaction
	(234992005,			'Сondition',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Plasma cell gingivitis
	...
	(193570009,			'Сondition', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Cataract
	(702809001,			'Сondition', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Drug reaction with eosinophilia and systemic symptoms
	(238986007,			'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Chemical-induced dermatological disorder
	(702809001,			'Сondition', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Drug reaction with eosinophilia and systemic symptoms
	(422593004,			'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Acute renal failure due to ACE inhibitor
	...
	--history:on
	(62014003,			'Сondition',	TO_DATE('20170810', 'YYYYMMDD'),	TO_DATE('20180820', 'YYYYMMDD')), -- Adverse reaction to drug
	...
	(403753000,			'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Adverse cutaneous reaction to acupuncture
	(402763002,			'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Adverse cutaneous reaction to diagnostic procedure
	(56317004,			'Condition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Alopecia
	(112401000119106,	'Сondition',	TO_DATE('20210127', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Lesion of conjunctiva
	...
	(1465031000000109,  'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Number of clinically significant hypoglycaemic episodes recorded by point-of-care monitoring of capillary blood glucose
	(1597861000000105,  'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Number of suspend episodes in insulin pump greater than 60 minutes
	(143541000237101,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Urinalysis observable
	(2661000237108,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Transferrin saturation index (Iron saturation/transferrin percent) in serum
	(50851000237104,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- RBCs (red blood cells) in blood smear microscopy qualitative result
	(65201000237103,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Fungal precipitin in serum qualitative result
	(50571000237109,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Fungal precipitin in plasma qualitative result
	(58601000237101,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Unconjugated E2 (oestradiol) molar concentration in serum
	(50401000237102,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Leucocytes in mid-stream urine microscopy qualitative result
	(50761000237108,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Pus cells in mid-stream urine microscopy qualitative result
	(51311000237102,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- RBCs (red blood cells) in mid-stream urine microscopy qualitative result
	(51761000237101,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Hyaline casts in mid-stream urine microscopy qualitative result
	(66641000237105,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- SARS-CoV-2 (severe acute respiratory syndrome coronavirus 2) IgM antibody in serum qualitative result
	(54591000237103,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Reticulated platelet percent count in blood
	(55461000237109,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Eosin 5-maleimide labelled red blood cells control MFI (mean fluorescence intensity) in blood
	(55511000237106,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- NK (natural killer) T lymphocyte percent count in blood
	(58481000237107,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Ethyl sulphate mass concentration in hair
	(6961000237104,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Catecholamine molar concentration in 24 hr urine
	(58041000237107,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Prostate health index
	(54031000237108,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Metamyelocyte percent count in blood
	(52641000237100,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Naive B lymphocyte percent count in blood
	(53291000237102,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Medium RNA reticulocyte percent count in blood
	(51151000237100,  	'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Clue cells in high vaginal swab microscopy qualitative result
	(396631001,  		'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Icterus index ordinal value in serumSurgical margin observable
	(364671000,  		'Measurement',	 TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Dialysis observable
	(13861000237103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Normirtazepine mass concentration in plasma
	(1241000237101,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Sexual abstinence duration
	(3041000237109,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Dopamine molar concentration in 24 hr urine
	(27921000237101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --HMMA (4-hydroxy-3-methoxymandelic acid)/creatinine molar concentration ratio in urine
	(49921000237109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blood group O+ RBC (red blood cell O antigen and Rhesus D antigen positive) in plasma qualitative result
	(50171000237102,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --RhD- blood group (Rhesus D antigen negative red blood cell) in plasma qualitative result
	(50601000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blood group A+ RBC (red blood cell A antigen positive and Rhesus D antigen positive) in plasma qualitative result
	(51071000237108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blood group AB+ RBC (red blood cell A and B antigen positive and Rhesus D antigen positive) in plasma qualitative result
	(51891000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blood group O- RBC (red blood cell O positive and Rhesus D antigen negative) in plasma qualitative result
	(57541000237101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Noradrenaline molar concentration in urine
	(59481000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blood group AB- RBC (red blood cell A and B antigen positive and Rhesus D antigen negative) in plasma qualitative result
	(66241000237108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blood group B+ RBC (red blood cell B antigen positive and Rhesus D antigen positive) in plasma qualitative result
	(68691000237103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Complement C3 nephritic factor presence in plasma
	(143451000237102,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Coagulation laboratory observable
	(143461000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Fertility testing observable
	(143531000237108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Toxicology laboratory observable
	(568331000005101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Intake of nutritional supplement
	(375911000119106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Differential count of white blood cells by automated method
	(15141000237109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Red blood cell count in fluid
	(55881000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Promyelocyte percent count in blood
	(52251000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blood group B- RBC (red blood cell B antigen positive and Rhesus D antigen negative) in plasma qualitative result
	(49941000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Epithelial cells in mid-stream urine microscopy qualitative result
	(567951000005106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Certainty of estimated date of delivery
	(630001000004109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Presence of metastatic discontinuous spread of malignant neoplasm of colon to pericolic tissue
	(3381000237101,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Glycophorin count percent in plasma
	(56091000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Small bowel biopsy weight in small intestine specimen
	(62921000237106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blood group A- RBC (red blood cell A antigen positive and Rhesus D antigen negative) in plasma qualitative result
	(56881000237106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Collagen/adrenaline closure time in blood
	(57031000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Methylglutarylcarnitine molar concentration in plasma
	(57591000237109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Eosin 5-maleimide labelled red blood cells control MFI (mean fluorescence intensity) in blood
	(60841000237107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --RhD+ blood group (Rhesus D antigen positive red blood cell) in plasma qualitative result
	(2381000237106,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Immature reticulocyte percent in blood
	(1464821000000102,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time below level 2 hypoglycaemic threshold to total continuous glucose monitoring time using minimally-invasive continuous glucose monitoring device
	(2541000237108,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Lambda cells percent in serum
	(2601000237109,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Oxcarbazepine metabolite mass concentration in serum
	(2991000237107,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Kappa cells percent in serum
	(3181000237104,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Platelet distribution width percent in blood
	(3741000237106,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --HVMA (homovanillylmandelic acid) molar concentration in 24 hr urine
	(11861000237102,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Oestradiol molar concentration in plasma
	(3771000237102,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Keratin arbitrary concentration in serum
	(31000237108,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Number of days abstinence prior to semen sample production
	(391000237102,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Eicosatrienoic acid molar concentration in serum
	(16151000237103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Normirtazepine mass concentration in serum
	(16181000237107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --White blood cell count in fluid
	(611000237104,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Smear cells percent in blood
	(4081000237100,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Platelet/neutrophil count ratio in blood
	(4331000237102,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Alpha amino butyrate molar concentration in serum
	(1281000237107,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Free beta HCG (human chorionic gonadotropin) multiple of the median in serum
	(52931000237101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Switched memory B lymphocyte percent count in blood
	(53001000237101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Non-switched memory B lymphocyte percent count in blood
	(53031000237105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --MCVr (mean cell volume of reticulocytes) in blood
	(53281000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Transitional B lymphocyte percent count in blood
	(53931000237106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Euglobulin clot lysis time time in blood
	(54451000237105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Turbidity index
	(54711000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Metamyelocyte count in blood
	(54871000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Patient height
	(55161000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blast cell percent count in bone marrow
	(55471000237104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Naive T lymphocyte percent count in blood
	(55491000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Patient weight
	(56101000237106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Low RNA reticulocyte percent count in blood
	(56231000237108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --7-Aminonitrazepam mass concentration in oral fluid
	(56411000237103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Blast cell percent count in blood
	(56551000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Eosin 5-maleimide labelled red blood cells MFI (mean fluorescence intensity) in blood
	(56661000237103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Thiocyanate molar concentration in serum
	(56801000237103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Plasmablasts percent count in blood
	(57381000237103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --High RNA reticulocyte percent count in blood
	(57711000237107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Reticulocyte percent count in blood
	(57731000237101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Haemolysis index
	(58051000237105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Plasma cells percent count in bone marrow aspirate
	(67561000237109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Carbonate and phosphate percent calculus content
	(67821000237101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --ADAMTS13 (disintegrin and metalloproteinase with thrombospondin type 1 motif 13) enzyme activity in plasma
	(67921000237109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Calculus weight
	(1290531000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Monkeypox virus qualitative result
	(1340001000004103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Number of metastatic discontinuous tumor deposits of primary malignant neoplasm of colon
	(1730561000004108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Presence of metastatic discontinuous spread of primary malignant neoplasm
	(1833121000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Wound, Ischemia and foot Infection classification system Wound grade
	(25761000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --sFlt-1 (soluble fms-like tyrosine kinase 1)/PlGF (placental growth factor) mass concentration ratio in serum
	(143381000237103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Allergy clinical laboratory observable
	(376201000119106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Differential count of white blood cells by manual method
	(1464671000000104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Mean substance concentration of glucose in capillary blood using minimally-invasive continuous glucose monitoring device
	(1464731000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Mean substance concentration of glucose in capillary blood by self-monitoring of blood glucose using blood glucose meter
	(1464741000000102,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Standard deviation of mean substance concentration of glucose in capillary blood using minimally-invasive continuous glucose monitoring device
	(1464751000000104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Standard deviation of mean substance concentration of glucose in capillary blood by self-monitoring of blood glucose using blood glucose meter
	(1464761000000101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Coefficient of variation of mean substance concentration of glucose in capillary blood using minimally-invasive continuous glucose monitoring device
	(1464771000000108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Coefficient of variation of mean substance concentration of glucose in capillary blood by self-monitoring of blood glucose using blood glucose meter
	(1464781000000105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time in target glucose range to total glucose monitoring time using minimally-invasive continuous glucose monitoring device
	(1464791000000107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time above level 2 hyperglycaemic threshold to total continuous glucose monitoring time using minimally-invasive continuous glucose monitoring device
	(1464801000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time above level 1 hyperglycaemic threshold to total continuous glucose monitoring time using minimally-invasive continuous glucose monitoring device
	(1464831000000100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time below level 1 hypoglycaemic threshold to total continuous glucose monitoring time using minimally-invasive continuous glucose monitoring device
	(1464841000000109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings in target range to total self-monitored capillary blood glucose readings using blood glucose meter
	(1853701000000102,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Wound, Ischemia and foot Infection classification system Ischemia grade
	(1853711000000100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Wound, Ischemia and foot Infection classification system foot Infection grade
	(1853721000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Wound, Ischemia and foot Infection classification system stage
	(2040001000004100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Presence of DNA mismatch repair protein Mlh1 in primary malignant neoplasm of colon by immunohistochemistry
	(2060001000004105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Presence of tumor bud in primary malignant neoplasm of colon
	(3550001000004108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Presence of receptor tyrosine-protein kinase erbB-2 in primary malignant neoplasm of breast by immunohistochemistry
	(3980001000004105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Radial location of primary malignant neoplasm in excised breast specimen
	(4050001000004108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Status of progesterone receptor stain in control cells by immunohistochemistry
	(26421000237108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Docosanoate (C22) molar concentration in plasma
	(26901000237105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Pyridinium crosslinks molar concentration in serum
	(1003521000004104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Number of tumor buds in primary malignant neoplasm of colon in microscopic field 0.785 mm2
	(1030001000004100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Site of excised primary malignant neoplasm of rectosigmoid colon relative to peritoneal reflection
	(1049601000000108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Number of weeks attendance of weight management programme
	(1577281000000108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Fredericson magnetic resonance imaging bone stress injury classification grade
	(1597771000000108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Mean time between replacement of continuous subcutaneous insulin infusion catheter in days
	(1597781000000105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Mean time between replacement of insulin infusion patch pump in days
	(1597801000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of successful data capture time to total expected wear time of insulin pump
	(1597811000000108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time in closed loop to total expected wear time of continuous automated insulin delivery system
	(1597871000000103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time spent by insulin pump in manual suspend
	(1597881000000101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time spent by continuous automated insulin delivery system in low glucose suspend
	(1597891000000104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of time spent by continuous automated insulin delivery system in predictive low glucose suspend
	(6270001000004106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Presence of ulcer in primary malignant melanoma of skin
	(30121000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Neurokinin A molar concentration in plasma
	(43871000237100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Plasmodium falciparum antigen arbitrary concentration in serum
	(46051000237109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Nucleated red blood cells percent in blood
	(50451000237101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Semen viscosity qualitative result
	(551791000124104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Superior transverse sacral axis motion
	(551801000124103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Longitudinal sacral axis motion
	(568121000005101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Irregular blood group antibody observable
	(568131000005103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Rhesus antibody observable
	(568161000005105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Maternal pre-pregnancy alcoholic beverage intake
	(591201000124109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Severe acute respiratory syndrome coronavirus 2 vaccination status
	(591251000124108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Oblique sacral axis motion
	(1464851000000107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings above level 2 hyperglycaemic threshold to total self-monitored capillary blood glucose readings using blood glucose meter
	(1464861000000105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings above level 1 hyperglycaemic threshold to total self-monitored capillary blood glucose readings using blood glucose meter
	(1464871000000103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings below level 2 hypoglycaemic threshold to total self-monitored capillary blood glucose readings using blood glucose meter
	(1464881000000101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings below level 1 hypoglycaemic threshold to total self-monitored capillary blood glucose readings using blood glucose meter
	(1464891000000104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Glucose Management Indicator expressed as substance concentration ratio
	(1464901000000103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Number of clinically significant hypoglycaemic episodes recorded by self-monitoring of capillary blood glucose
	(1464911000000101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Number of clinically significant hypoglycaemic episodes recorded by continuous glucose monitoring device
	(1464921000000107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Mean duration of hypoglycaemic episodes in minutes
	(1464931000000109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Mean number of self-monitored capillary blood glucose measurements per day
	(1464941000000100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of successful data capture time to total expected continuous glucose monitoring sensor wear time using minimally-invasive continuous glucose monitoring device
	(1464951000000102,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Mean substance concentration of glucose in capillary blood using point-of-care testing device
	(1464961000000104,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Standard deviation of mean substance concentration of glucose in capillary blood using point-of-care testing device
	(1464971000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Coefficient of variation of mean substance concentration of glucose in capillary blood using point-of-care testing device
	(1464981000000108,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings in target range to total point-of-care capillary blood glucose readings using blood glucose meter
	(1464991000000105,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings above level 2 hyperglycaemic threshold to total point-of-care capillary blood glucose readings using blood glucose meter
	(1465001000000103,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings above level 1 hyperglycaemic threshold to total point-of-care capillary blood glucose readings using blood glucose meter
	(1465011000000101,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings below level 2 hypoglycaemic threshold to total point-of-care capillary blood glucose readings using blood glucose meter
	(1465021000000107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of readings below level 1 hypoglycaemic threshold to total point-of-care capillary blood glucose readings using blood glucose meter
	(1465041000000100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Mean number of point-of-care capillary blood glucose measurements per day
	(1505281000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Estimated quantity of carbohydrate intake in grams during breakfast meal
	(1515521000000109,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Estimated quantity of carbohydrate intake in grams during lunch meal
	(1515531000000106,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Estimated quantity of carbohydrate intake in grams during evening meal
	(1515541000000102,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Estimated quantity of carbohydrate intake in grams during snack time
	(1515591000000107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Insulin sensitivity factor - snack time
	(1515761000000107,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentage of continuous glucose monitoring sensor failures to total sensors applied recorded by subject of record
	(1546631000004100,	'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Presence of direct invasion by primary malignant neoplasm of prostate to nerve
	(5381000237102,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Immature platelet fraction percent in blood
	(5541000237100,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Alternative (AP100) complement pathway haemolytic activity percent in serum
	(6381000237107,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Reactive lymphocyte percent in blood
	(6411000237109,		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Calculated serum osmolarity molar concentration in serum
	...
	(698101006,  	'Observation', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Smoking device
...
--	(736478001,		'Drug',  		TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Basic dose form
	...
	(446428008,  		'Measurement',	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Evaluation of musculoskeletal system
	(252758009,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Electromyography of anal sphincter
	(284393006,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Examination of joint
	(363119001,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Exploration of musculoskeletal system
	(441958009,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Imaging of musculoskeletal system
	(107739004,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Musculoskeletal system endoscopy
	(363215001,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Musculoskeletal system physical examination
	(447486003,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Perioperative evaluation of musculoskelatal system
	(68848009,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Transillumination of newborn skull
	(418419008,  		'Procedure', 	TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Virtual CT bronchoscopy
	...
	(272099008,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Descriptor
	(258395000,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Levels
	(258391009,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Classes
	(272423005,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Degrees of severity
	(258237008,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Editions
	(272422000,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Fractions of movement
	(264752007,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Grading values
	(261586004,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Groups
	(415068004,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Percentile value
	(449741000124101,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Preparation level
	(261612004,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Stages
	(277975002,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Temperature ranges
	(278159002,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --FAB type values
	(276726000,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Microbiology subtype
	(272397003,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Numerical types
	(272402004,		'Meas Value',TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Types TH

	(246292004,		'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Level of arrest
	(134408007,		'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Cycle of change stage
	(309689007,		'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), --Occult carcinoma - stage
...
-- Social context
	...
	(226916002, 	'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Beef
	(1284919009, 	'Observation',  TO_DATE('20230914', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD')), -- Bovine gelatin
...
SELECT b.* FROM (VALUES
	...
	(366256008,		'Observation',  TO_DATE('20201210', 'YYYYMMDD'),	TO_DATE('20991231', 'YYYYMMDD'), 1),  --Finding of bowel action
