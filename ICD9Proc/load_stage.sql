...
--14 Deprecate replacement records if target concept was depreceted 
...
--18 Add "subsumes" relationship between concepts where the concept_code is like of another
...
--19 Update concept_id in concept_stage from concept for existing concepts
UPDATE concept_stage cs
...
--20 Reinstate constraints and indices
