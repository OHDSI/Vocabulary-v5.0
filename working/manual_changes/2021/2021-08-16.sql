...
begin
	...
	update concept c set concept_name=cNewVocabulary where c.vocabulary_id='Vocabulary' and c.concept_id=(select v.vocabulary_concept_id from vocabulary v where v.vocabulary_id=cOldVocabulary);
	update vocabulary set vocabulary_id=cNewVocabulary, vocabulary_reference='https://www.nahdo.org/sopt' where vocabulary_id=cOldVocabulary;
