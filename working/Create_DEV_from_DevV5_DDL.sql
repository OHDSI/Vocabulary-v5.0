...
BEGIN
	...
	INSERT INTO concept_ancestor SELECT * FROM devv5.concept_ancestor;
	...
	INSERT INTO concept_relationship SELECT * FROM devv5.concept_relationship;
	...
	INSERT INTO concept_synonym SELECT * FROM devv5.concept_synonym;
