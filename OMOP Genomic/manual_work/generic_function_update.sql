CREATE OR REPLACE FUNCTION dev_genomic.GenericUpdate (
)
RETURNS void AS
$BODY$
BEGIN
	...
	****************************/
	...
	AND CASE -- all vocabularies that give us a full list of active concepts at each release we can safely assume to deprecate missing ones (THEN 1)
		...
		WHEN c.vocabulary_id = 'ClinVar' THEN 1
		WHEN c.vocabulary_id = 'JAX' THEN 1
		WHEN c.vocabulary_id = 'NCIt' THEN 1
	    ...
	    WHEN c.vocabulary_id = 'OMOP Genomic' THEN 1
