...
insert into concept_relationship_manual
select a.concept_code, c.concept_code, a.vocabulary_id, c.vocabulary_id, r.relationship_id, r.valid_start_date, to_DATE ('2022-01-25','yyyy-MM-dd'), 'D' from concept a 
join concept_relationship r on a.concept_id = r.concept_id_1 and r.invalid_reason is null
join concept c on r.concept_id_2 = c.concept_id
