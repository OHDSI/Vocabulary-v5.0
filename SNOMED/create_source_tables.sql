...
CREATE TABLE SCT2_RELA_FULL_US
(
   ID                     INTEGER,
   EFFECTIVETIME          VARCHAR2 (8 BYTE),
   ACTIVE                 VARCHAR2 (1 BYTE),
...
CREATE TABLE SCT2_DESC_FULL_EN_US
(
   ID                   INTEGER,
   EFFECTIVETIME        VARCHAR2 (8 BYTE),
   ACTIVE               VARCHAR2 (1 BYTE),
...
CREATE TABLE SCT2_CONCEPT_FULL_US
(
   ID              VARCHAR2 (18 BYTE),
   EFFECTIVETIME   VARCHAR2 (8 BYTE),
   ACTIVE          VARCHAR2 (1 BYTE),
...
CREATE INDEX X_rel_id_us
   ON SCT2_RELA_FULL_US (ID);

CREATE INDEX X_DESC_2CD_US
   ON SCT2_DESC_FULL_EN_US (CONCEPTID, MODULEID);

CREATE INDEX X_CID_US
   ON SCT2_CONCEPT_FULL_US (ID);

-- Create views combining the Int and UK versions
CREATE VIEW sct2_concept_full_merged AS SELECT * FROM sct2_concept_full_int UNION SELECT * FROM  sct2_concept_full_uk UNION SELECT * FROM  sct2_concept_full_us;
CREATE VIEW sct2_desc_full_merged AS SELECT * FROM sct2_desc_full_en_int UNION SELECT * FROM sct2_desc_full_uk  UNION SELECT * FROM  sct2_desc_full_en_us;
CREATE VIEW sct2_rela_full_merged AS SELECT * FROM sct2_rela_full_int UNION SELECT * FROM sct2_rela_full_uk  UNION SELECT * FROM  sct2_rela_full_us;
