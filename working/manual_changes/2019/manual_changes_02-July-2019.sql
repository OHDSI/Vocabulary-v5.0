--new relationships for NAACCR
DO $$
DECLARE
    z    int;
    ex   int;
    pRelationship_name constant varchar(100):='Has parent item (NAACCR)';
    pRelationship_id constant varchar(100):='Has parent item';
    pIs_hierarchical constant int:=0;
    pDefines_ancestry constant int:=0;
    pReverse_relationship_id constant varchar(100):='Parent item of';
    
    pRelationship_name_rev constant varchar(100):='Parent item of (NAACCR)';
...
DECLARE
    z    int;
    ex   int;
    pRelationship_name constant varchar(100):='Variable has date (NAACCR)';
    pRelationship_id constant varchar(100):='Variable has date';
    pIs_hierarchical constant int:=0;
    pDefines_ancestry constant int:=0;
    pReverse_relationship_id constant varchar(100):='Date of variable';
    
    pRelationship_name_rev constant varchar(100):='Date of variable (NAACCR)';
    pIs_hierarchical_rev constant int:=0;
    pDefines_ancestry_rev constant int:=0;
BEGIN
    DROP SEQUENCE IF EXISTS v5_concept;
