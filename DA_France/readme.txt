1. Run munual_tables.sql to get source table and tables we created munualy (translation France concepts to English or mapping tables);

2. Run non_drug_concept_stage.sql to get list of non-drug concepts we need to exclude from standard tables;

3. Run standard tables creation.sql to get standard tables such as;
