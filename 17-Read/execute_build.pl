...
system("unzip -u nhs_readv2_17.0.0_20140401000001.zip\n");
system("unzip -u nhs_datamigration_17.0.0_20140401000001.zip\n");

#copy files from zips to the current directory
my $oldfile1 = "V2/Unified/Keyv2.all";
my $oldfile2 = "Mapping Tables/Updated/Clinically Assured/rcsctmap2_uk_20140401000001.txt";
my $newfile = "./";
