...
-- insert new mapping
INSERT INTO concept_relationship_manual SELECT icd_code, repl_by_code, 'ICD10CM', repl_by_vocabulary, CASE WHEN repl_by_relationship = 'Is a' THEN 'Maps to' ELSE repl_by_relationship END, CURRENT_DATE, TO_DATE('20991231','YYYYMMDD'), NULL FROM refresh_lookup_done;
