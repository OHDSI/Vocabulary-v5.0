...
* Date: 2021
**************************************************************************/
-- 1. Update concept_relationship_stage
...
FROM concept a
JOIN concept_relationship r ON r.concept_id_1 = a.concept_id AND a.vocabulary_id = 'KCD7'
...
JOIN concept_relationship r ON r.concept_id_1 = a.concept_id and a.vocabulary_id = 'KCD7'
JOIN concept d ON d.concept_id = r.concept_id_2 AND r.invalid_reason IS NULL AND d.standard_concept = 'S' AND r.relationship_id IN ('Maps to', 'Maps to value')
  JOIN concept_synonym cs ON lower (a.concept_name) = lower (cs.concept_synonym_name) AND a.vocabulary_id = 'KCD7'
  JOIN concept c
