...
--france_names_translation_v2
--INGR_NEED_TO_MAP_DONE  --munualy created table of ingredients mapping
--BRAND_NEED_TO_MAP_DONE  --munualy created table of brands mapping
--new_form_name_mapping  
--add_ingr 
...
;
--insert addition form mapping  --form_changes - don't need this anymore
/*
insert into relationship_to_concept (concept_code_1, vocabulary_id_1, concept_id_2, precedence, conversion_factor)
...
;
delete from drug_concept_stage where concept_code in (select concept_code from non_drug_concept_stage)
;
delete from drug_strength_stage where drug_concept_code in (select concept_code from non_drug_concept_stage)
;
delete from internal_relationship_stage where concept_code_1 in (select concept_code from non_drug_concept_stage)
;
delete from relationship_to_concept where concept_code_1 in (select concept_code from non_drug_concept_stage)
;
